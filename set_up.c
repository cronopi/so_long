...
void	set_up(t_patata *patata)
{
	...
	patata->img.exit_portal =  mlx_xpm_file_to_image(patata->mlx, "portal.xpm",  &(patata->img.portal_size.x), &(patata->img.portal_size.y));
	...
	patata->img.pacman[0] = mlx_xpm_file_to_image(patata->mlx, "pac_open_right.xpm", &(patata->a.x), &(patata->a.y));
	patata->img.pacman[1] = mlx_xpm_file_to_image(patata->mlx, "pac_open_up.xpm", &(patata->a.x), &(patata->a.y));
	patata->img.pacman[2] = mlx_xpm_file_to_image(patata->mlx, "pac_open_down.xpm", &(patata->a.x), &(patata->a.y));
	patata->img.pacman[3] = mlx_xpm_file_to_image(patata->mlx, "pac_open_left.xpm", &(patata->a.x), &(patata->a.y));
}
